...
out_vox@voxels = out_vox@voxels[order(out_vox@voxels$i,out_vox@voxels$j,out_vox@voxels$k),]
writeVoxelSpace (out_vox,"/home/jimmy/Bureau/ALS_P15_1m_modR_fus0.vox")

time5 = Sys.time()
cat("total time TT : ", difftime(time5,time1,units="mins"), "minutes\n")
